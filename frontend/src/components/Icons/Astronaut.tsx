...
export const Astronaut = createIcon({
  displayName: "Astronaut",
  viewBox: "0 0 512 512",
  path: [
    <circle cx="256.8" cy="255.3" r="247.9" fill="none" />,
    <path
      d="M346.4 475H164.9V244.8c0-14 11.4-25.4 25.4-25.4H321c14 0 25.4 11.4 25.4 25.4V475z"
      fill="#f39e72"
    />,
    <path
      d="M346.4 470H165l5 5V349.9v-80-21.4c0-10.3 3.9-20.3 15-23.3 6.4-1.8 14.2-.7 20.7-.7h112.4c3.3 0 6.5 0 9.7 1.1 8.3 2.9 13.5 
    10.7 13.7 19.3.1 4.1 0 8.3 0 12.5v217.7c0 6.4 10 6.4 10 0v-130-79.5-19.1c-.1-13.8-7.6-26-21-30.5-7.2-2.4-15.8-1.5-23.3-1.5H192.9c-14.8 0-28.7 8.4-32 23.6-1.1 5.2-.8 10.8-.8 16.1V475c0 2.7 2.3 5 5 5h181.4c6.3 0 6.3-10-.1-10z"
      fill="#504e55"
    />,
    <path
    ...
    <path
      ...
      fill="#504e55"
    />,
    <circle cx="230.7" cy="316.7" r="10.4" fill="#ececec" />,
    <path
      ...
      fill="#504e55"
    />,
    <circle cx="230.7" cy="345.2" r="10.4" fill="#f4a89c" />,
    <path
    ...
    <path
      ...
      fill="#504e551 #504e552"
    />,
    <path d="M371.6 128.9l25.1-23.8" fill="#504e553" />,
    <path
      ...
      fill="#504e55"
    />,
    <path d="M139.7 128.9l-25.1-23.8" fill="#504e553" />,
    <path
      ...
      fill="#504e55"
    />,
    <circle cx="114.6" cy="105.1" r="4.8" fill="#504e554" />,
    <path
      ...
      fill="#504e555"
    />,
    <circle cx="396.7" cy="105.1" r="4.8" fill="#504e556" />,
    <path
      ...
      fill="#504e555"
    />,
    <path d="M351.9 478.1H376" fill="#fff" />,
    <g>
      <path d="M138 478.1h-18.3" fill="#fff" />
    </g>,
    <g>
      <path
